...
export default function DataTable(props) {
  ...
  // Dentro do DataTable, antes do return
  console.log('CRUD props:', props.crud)
  console.log('VIEW permission:', permissions[props.crud[VIEW]])
  console.log('EDIT permission:', permissions[props.crud[EDIT]])
